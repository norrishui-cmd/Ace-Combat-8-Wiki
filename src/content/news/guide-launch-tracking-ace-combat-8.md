...
Edition owners), and Bandai Namco has already confirmed a lot: over 30 playable aircraft
across four categories, a returning Ace Style gauge, a new dual special weapon system, and
the series' first cross-platform online mode, Ace Combat Online.

We're building this guide in parallel with the game's own reveal schedule — every aircraft
confirmation, every dev diary, every editions or Ace Pass detail gets logged here, usually
within a day of the official announcement.
...
See our [aircraft list](/aircraft) and [editions comparison](/editions) for the full
breakdown, and check back — this page and the rest of the guide get updated as soon as
